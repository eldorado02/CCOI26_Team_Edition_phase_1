#!/usr/bin/env python3
# KnightShop v2 solver
# registration code: I_Am_Knight (indices [8,7,5,6,7,3,4,10,1,2,0] sur key_part_1)
# captcha: isoler pixels=200 + tesseract (~50% succes, boucle de retry)
# honeypot: champ 'website' doit etre vide
# CSRF: recuperer depuis la page avant chaque POST
...
def ocr_captcha(session):
    ...
    arr = np.array(img)
    # pixels=200 -> texte, reste -> fond noir
...
for attempt in range(30):
    ...
    cap = ocr_captcha(s)  # meme session que la page register !
